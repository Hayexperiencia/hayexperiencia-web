...
export const metadata: Metadata = {
  title: "El Faro — Condominio Nautico en El Penol",
  ...
  openGraph: {
    title: "El Faro — Condominio Nautico sobre la represa de Guatape",
    description: "Peninsula exclusiva con 1.5 km de costa, sede nautica y vistas 360 de la represa.",
...
const UNIDADES = [
  { tipo: "Suite Simplex", desc: "Apartamento en un nivel, ideal para parejas o inversion", desde: "" },
  ...
  { tipo: "Villa 3 niveles", desc: "Casa amplia con terraza y vistas panoramicas", desde: "" },
  { tipo: "Villa en terreno plano", desc: "Casa con jardin privado y acceso directo", desde: "" },
];
...
const PROPUESTA_VALOR = [
  {
    ...
    title: "Peninsula exclusiva",
    desc: "10 cuadras rodeadas de agua, con 1.5 km de costa sobre la represa de Guatape.",
  },
  {
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Acceso nautico directo",
    desc: "Sede nautica con muelles propios. Sal al agua desde tu condominio.",
  },
  {
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Inversion con retorno",
    desc: "Arrienda tu unidad cuando no la uses. La represa de Guatape es destino turistico todo el ano.",
  },
];
    ...
    <div>
      ...
      <section className="relative bg-[var(--color-primary)] overflow-hidden min-h-[70vh] flex items-center">
        <div className="absolute inset-0">
          <Image src="/images/proyectos/el-faro-hero.jpg" alt="El Faro - Peninsula sobre la represa" fill className="object-cover opacity-30" priority />
        </div>
        <div className="relative mx-auto max-w-4xl text-center px-4 py-24">
          ...
          <p className="mt-4 text-xl sm:text-2xl text-gray-300 max-w-2xl mx-auto">
            Condominio Nautico en El Penol — Peninsula sobre la represa de Guatape
          </p>
          <a
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-[var(--color-text-light)] leading-relaxed mb-4">
            Condominio Nautico El Faro se levanta en una peninsula privilegiada de 10 cuadras con
            1.5 km de perimetro costero sobre la represa de Guatape, en El Penol, Antioquia.
          ...
          <p className="text-lg text-[var(--color-text-light)] leading-relaxed">
            ...
            con las comodidades de un condominio moderno: sede nautica con muelles, senderos ecologicos,
      ...
      <section className="py-12 bg-[var(--color-accent)]">
        <div className="mx-auto max-w-3xl text-center px-4">
          ...
          <p className="mt-2 text-[var(--color-primary)]/80">Agenda una visita a la peninsula y descubre el proyecto en persona.</p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[var(--color-primary)] mb-6">Avance del proyecto</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            <div className="p-6 rounded-2xl bg-gray-50 text-center">
              <div className="text-4xl font-bold text-[var(--color-accent)]">66%</div>
            ...
            <div className="p-6 rounded-2xl bg-gray-50 text-center">
              ...
              <div className="text-sm text-[var(--color-text-light)] mt-1">Tipos de unidad</div>
            </div>
            <div className="p-6 rounded-2xl bg-gray-50 text-center">
              <div className="text-sm font-semibold text-[var(--color-primary)]">Foco de comercializacion</div>
              <div className="text-sm text-[var(--color-text-light)] mt-1">2026</div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50/50">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl overflow-hidden">
            <iframe
              src="https://www.google.com/maps?q=6.2290,-75.1740&z=14&output=embed"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Ubicacion El Faro - El Penol"
            />
          </div>
          <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
            <div className="p-3 rounded-xl bg-white text-center">
              <div className="font-semibold text-[var(--color-primary)]">El Penol</div>
            ...
            <div className="p-3 rounded-xl bg-white text-center">
              <div className="font-semibold text-[var(--color-primary)]">Represa Guatape</div>
            ...
            <div className="p-3 rounded-xl bg-white text-center">
              ...
              <div className="text-[var(--color-text-light)]">Peninsula</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[var(--color-primary)]">
        <div className="mx-auto max-w-3xl text-center px-4">
          ...
          <p className="mt-4 text-gray-300">La peninsula sobre la represa de Guatape. Tu proximo destino, tu proxima inversion.</p>
