      ...
      <section id="plan" className="bg-verde px-6 py-20 md:px-12 md:py-28 text-crema">
        <Reveal className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a href="/aluna/cotizador" className="inline-block rounded-full bg-tierra px-9 py-4 text-base font-semibold text-verde transition hover:bg-tierra-400 hover:-translate-y-0.5">Calcula tu plan de pagos</a>
